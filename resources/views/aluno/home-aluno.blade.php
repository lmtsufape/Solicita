          ...
          <div class="card-deck d-flex justify-content-center">
              ...
              <div class="conteudo-central d-flex justify-content-center">
                  ...
                  <!-- <div class="card cartao text-center " style="border-radius: 20px" href="#" onclick="event.preventDefault(); document.getElementById('formulario').submit();">
                      <form id="formulario" action="{{ route('formulario_requisicao') }}" method="GET" style="display: none;">
                           @csrf<
                               </form>
                 ...
                 <a href="{{ route("formulario_requisicao", ["titulo" => "Solicitar Documentos"]) }}" style="text-decoration:none; color: inherit;">
                 ...
                 <a href="{{ route("requisicoes_aluno", ["titulo" => "Listar Documentos Solicitados"]) }}" style="text-decoration:none; color: inherit;">
                    <div class="card cartao text-center " style="border-radius: 30px">
                     <div class="card-body d-flex justify-content-center">
