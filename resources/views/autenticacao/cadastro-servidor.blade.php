          ...
          <form method="POST" action="{{route('cadastro-servidor')}}" id=form>
            ...
            <div class="form-group row formulario-centro">
                <div class="col-md-9">
                    ...
                    name="matricula" value="{{ old('matricula') }}" required="" autocomplete="matricula" autofocus placeholder="Matricula" >
            ...
            <div class="form-group row formulario-centro">
                ...
                <div class="col-md-9">
                    ...
                    name="email" value="{{ old('email') }}" required="" autocomplete="email" autofocus placeholder="E-Mail" id = "emailServidor">
            ...
            <div class="form-group row mb-0" style="margin-center">
                    <div class="col-md-8 offset-md-4">
                      <a class="btn btn-primary btn-primary-lmts" href="{{route('cadastro-servidor')}}">
                      {{ ('Cadastrar') }}
                      </a>
